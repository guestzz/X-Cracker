...
public class CrackActivity extends AppCompatActivity {
    ...
    private Runnable mRunnable = new Runnable() {
        public void run() {
            ...
            try {
                gifDrawable = new GifDrawable(getResources(), R.drawable.caculating);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle bundle_before=intent_before.getExtras();
        String input_message=bundle_before.getString("input_message");
